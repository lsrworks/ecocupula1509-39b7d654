    ...
    <div className="pt-16">
      ...
      <section className="section-padding bg-eco-gray-light">
        <div className="container-eco">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-display font-bold mb-4">
              Domos Famosos pelo Mundo
            </h2>
            <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
              Exemplos icônicos que demonstram a versatilidade e o impacto dos domos geodésicos 
              na arquitetura e no turismo mundial
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-16">
            {applications.map((app, index) => (
              <div key={index} className="card-eco p-8">
                <h3 className="text-xl font-display font-semibold mb-4 text-primary">{app.title}</h3>
                <p className="text-muted-foreground leading-relaxed">{app.description}</p>
              </div>
            ))}
          </div>

          {/* Brazilian Famous Domes */}
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-display font-bold mb-4">
              Domos Famosos no Brasil
            </h2>
            <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
              Projetos arquitetônicos icônicos que utilizam estruturas geodésicas no território brasileiro
            </p>
          </div>

          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="card-eco p-8">
              <h3 className="text-xl font-display font-semibold mb-4 text-primary">Museu Inhotim</h3>
              <p className="text-muted-foreground leading-relaxed">
                Localizado em Brumadinho/MG, o complexo artístico possui estruturas geodésicas que abrigam 
                obras de arte contemporânea, demonstrando a versatilidade dos domos em espaços culturais.
              </p>
            </div>

            <div className="card-eco p-8">
              <h3 className="text-xl font-display font-semibold mb-4 text-primary">Torre de TV Digital "Flor do Cerrado"</h3>
              <p className="text-muted-foreground leading-relaxed">
                Projetada por Oscar Niemeyer em Brasília/DF, incorpora elementos geodésicos em sua estrutura, 
                sendo um marco da arquitetura moderna brasileira.
              </p>
            </div>

            <div className="card-eco p-8">
              <h3 className="text-xl font-display font-semibold mb-4 text-primary">Planetário da Gávea</h3>
              <p className="text-muted-foreground leading-relaxed">
                No Rio de Janeiro/RJ, utiliza estrutura geodésica para criar um ambiente imersivo único, 
                proporcionando experiências educacionais memoráveis aos visitantes.
              </p>
            </div>

            <div className="card-eco p-8">
              <h3 className="text-xl font-display font-semibold mb-4 text-primary">Borboletário do Museu Catavento</h3>
              <p className="text-muted-foreground leading-relaxed">
                Em São Paulo/SP, a estrutura geodésica transparente cria um habitat perfeito para borboletas, 
                demonstrando a aplicação em projetos de conservação e educação ambiental.
              </p>
            </div>
          </div>
        </div>
